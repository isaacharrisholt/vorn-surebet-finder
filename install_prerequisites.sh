...
apt-get install chromium-chromedriver || sudo apt-get install chromium-chromedriver || apt install chromium-chromedriver || sudo apt install chromium-chromedriver || brew install chromedriver
xattr -d com.apple.quarantine ./chromedriver/chromedriver_mac || echo
spctl --add --label 'Approved' ./chromedriver/chromedriver_mac || echo